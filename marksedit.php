...
if($_SERVER['REQUEST_METHOD']=="POST")
{
  ...
  $sub2=$_POST['sub2Edit'];
  $sub3=$_POST['sub3Edit'];
  $sql="UPDATE `marks` SET `sub1`='$sub1' ,`sub2`='$sub2',`sub3`='$sub3' WHERE `marks`.`sno`='$sno' ";
  ...
  {
    $sno=$_POST['snoDel'];
    $sql="DELETE FROM `marks` WHERE `marks`.`sno` = '$sno'";
    $result=mysqli_query($con,$sql);
    if($result)
    {
      $delete=true;
        ...
        <form action="marksedit.php" method="POST">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="sub1Edit">Computer Graphics</label>
              <input type="text" class="form-control" id="sub1Edit" name="sub1Edit" aria-describedby="emailHelp">
            </div>

            <div class="form-group">
              <label for="sub2Edit">Web Technologies</label>
              <textarea class="form-control" id="sub2Edit" name="sub2Edit" rows="3"></textarea>
            </div> 

            <div class="form-group">
              <label for="sub3Edit">Sensor Networks</label>
              <textarea class="form-control" id="sub3Edit" name="sub3Edit" rows="3"></textarea>
            </div> 
          </div>
    ...
    <table class="table" id="mytable">
      <thead>
        <tr>
          ...
          <th scope="col">ID</th>
          <th scope="col">Computer Graphics</th>
          <th scope="col">WebTechnologies</th>
          <th scope="col">Sensor Networks</th>
    ...
    Array.from(edits).forEach((element)=>{
      element.addEventListener('click',(e)=>{
        tr=e.target.parentNode.parentNode;
          sub1=tr.getElementsByTagName('td')[3].innerText;
          sub2=tr.getElementsByTagName('td')[4].innerText;
